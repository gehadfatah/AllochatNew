...
import com.crazyhitty.chdev.ks.firebasechat.ui.fragments.LoginFragment;
...
public class GetUsersPresenter implements GetUsersContract.Presenter, GetUsersContract.OnGetAllUsersListener {
    ...
    @Override
    public void getAllUsers(boolean loginOrchat) {
        if (mView.equals(LoginFragment.newInstance())) {
            mGetUsersInteractor.getAllUsersFromFirebase(loginOrchat);
