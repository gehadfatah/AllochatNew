...
public class RegisterFragment extends Fragment implements View.OnClickListener, RegisterContract.View, AddUserContract.View {
    ...
    private EditText mETxtEmail, mETxtPassword,mETxtPhone;
    ...
    private void bindViews(View view) {
        ...
        mETxtPhone = (EditText) view.findViewById(R.id.edit_text_phone);
    }
    ...
    private void onRegister(View view) {
        ...
        new SharedPrefUtil(getActivity()).saveString(Constants.ARG_USER_EMAIL, emailId);
        new SharedPrefUtil(getActivity()).saveString(Constants.ARG_USER_password, password);
    ...
    public void onRegistrationSuccess(FirebaseUser firebaseUser) {
        ...
        //after register or authentication success add user to firebase database
        mAddUserPresenter.addUser(getActivity().getApplicationContext(),phone, firebaseUser);
    }
